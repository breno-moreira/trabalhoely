...
<div class="container">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <c:forEach var="jogo" items="${lDao.listar()}">
                <tr>
                    ...
                    <td class="text-center">
                        <a href="edd_livros.jsp?id=${livro.idlivros}" class="btn btn-warning btn-sm">Alterar</a>
                        <a href="excluir.jsp?id=${livro.idlivros}" class="btn btn-danger btn-sm">Excluir</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
